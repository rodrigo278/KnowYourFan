...
def create_interest_chart(interests_data):
    ...
    if categories:
        ...
        fig = px.bar(
            ...
            y='Interest Score', 
            color='Type',
            color_discrete_map={'Game': '#FF5722', 'Team': '#2196F3'},
            labels={'Interest Score': 'Interest Level (1-10)', 'Category': ''},
            title='Your Esports Interests'
        )
        ...
        fig = go.Figure()
        fig.add_annotation(
            text="No interest data available",
            xref="paper",
            yref="paper",
            x=0.5,
            y=0.5,
...
def create_activity_timeline(social_media_analysis):
    ...
    if activity:
        ...
        # Update layout
        fig.update_layout(
            title='Esports Social Media Activity (Last 6 Months)',
            xaxis_title='Date',
            yaxis_title='Count',
        ...
        fig = go.Figure()
        fig.add_annotation(
            text="No social media activity data available",
            xref="paper",
            yref="paper",
            x=0.5,
            y=0.5,
...
def create_engagement_radar(social_media_analysis, interests_data):
    ...
    categories = ['Social Media Presence', 'Game Knowledge', 'Team Support', 
                 'Event Attendance', 'Content Creation', 'Community Involvement']
